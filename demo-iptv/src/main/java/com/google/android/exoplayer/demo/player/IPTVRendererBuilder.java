 ...
 */
public class IPTVRendererBuilder implements RendererBuilder {
  ...
  public IPTVRendererBuilder(Context context, Uri uri) {
  ...
  public void buildRenderers(DemoPlayer player) {
    ...
    MediaCodecVideoTrackRenderer videoRenderer = new MediaCodecVideoTrackRenderer(context,
        sampleSource, MediaCodecSelector.DEFAULT, MediaCodec.VIDEO_SCALING_MODE_SCALE_TO_FIT, 1000,
